  ...
  foreach($this->domains as $domain=>$users) {
	 ...
	 $this->domain = $domain;
	  ...
	  if ($this->sock) {
	   ...
	   // say helo
	   //$this->from_domain = 'relay-hosting.secureserver.net';
	   $this->from_domain = $_SERVER['HTTP_HOST'];
	   
	   $this->send("HELO ".$this->from_domain);
	   // tell of sender
	   print_r('From Domain '.$this->from_domain);
	   print_r($this->send("MAIL FROM: <".$this->from_user.'@'.$this->from_domain.">"));
