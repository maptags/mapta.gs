...
<meta name="alexaVerifyID" content="5H1TzN9QZFKXWbDKifmVj_63G6c"/>
 <meta name="description" content=" Maptags is the worlds easiest Address sharing platform, Maptags shortens your address to your favourite word so sharing your address is easy as sharing a word which takes away the pain of writing address forever. Maptags is integrated to Google Maps hence providing seamless driving directions which ensures you never lose your way ">
  ...
  <script async src="<?php echo base_url()?>assets/js/toastr.min.js"></script>
  <script  src="https://maps.googleapis.com/maps/api/js?sensor=true&libraries=places"></script>
  <script async type="text/javascript" src="<?php echo base_url()?>assets/fancybox/lib/jquery.mousewheel-3.0.6.pack.js"></script>
  <link rel="stylesheet" href="<?php echo base_url()?>assets/fancybox/source/jquery.fancybox.css?v=2.1.5" type="text/css" media="screen" />
  <script async type="text/javascript" src="<?php echo base_url()?>assets/fancybox/source/jquery.fancybox.pack.js?v=2.1.5"></script>
  ...
  <script async type="text/javascript" src="<?php echo base_url()?>assets/fancybox/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>
  <script async type="text/javascript" src="<?php echo base_url()?>assets/fancybox/source/helpers/jquery.fancybox-media.js?v=1.0.6"></script>
  ...
  <script async type="text/javascript" src="<?php echo base_url()?>assets/fancybox/source/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>
  <script async src="<?php echo base_url()?>assets/js/bootbox.min.js"></script>
  <script async src="<?php echo base_url()?>assets/js/plaacev3.js"></script>
              ...
              request.done(function( msg ) {
                ...
                if(msg.code === 1){
                 ...
                 $('#share_maptag').modal('hide');
                  ...
                  toastr.warning("Oops, You can only have 50 Maptags");

                }

                else if(msg.code === 3){

                  toastr.error("Maptag taken,please try something else ");

                }

                else if(msg.code === 4){

                  toastr.warning("Please Enter alphabets or numbers ");
...
$('.panel-heading span.clickable').on("click", function (e) {
  ...
  if ($(this).hasClass('panel-collapsed')) {
    ...
    <!--[if lt IE 9]>
      ...
      <![endif]-->
      <?php if ( $this->session->userdata('logged_in') != true && $this->input->cookie('login-modl') != $this->input->ip_address()) { ?>
         <script type="text/javascript">
      ...
      $this->input->set_cookie($map_login_cookie);
        } 
      ?>
      <?php if ( $this->session->userdata('logged_in') && $this->input->cookie('maptag-modl') != $this->input->ip_address() ) { 
        $id = $this->session->userdata('member_id');
        $query = $this->db->get_where('custom_track', array('user_id' => $id) );
        if($query->num_rows() == 0){
      ...
      ?>
         <script type="text/javascript">
            ...
            setTimeout(function(){
                $("#create-maptag").modal('show');
              }, 1000);
           
         </script>

      <?php 
          $map_maptga_cookie = array(
                    'name'   => 'maptag-modl',
                    'value'  => $this->input->ip_address(),
                    'expire' => '604800',
          ...
          $this->input->set_cookie($map_maptga_cookie);
        } 
        else if( $query->num_rows() > 0 && $this->input->cookie('maptag-share-modl') != $this->input->ip_address()){ ?>
        <script type="text/javascript">
         
            setTimeout(function(){
               // $("#share_maptag_social").modal('show');
              }, 10000);
           
         </script>
        <?php
        $map_share_maptga_cookie = array(
                    'name'   => 'maptag-share-modl',
                    'value'  => $this->input->ip_address(),
                    'expire' => '604800',
                    
                );

          $this->input->set_cookie($map_share_maptga_cookie);
      }
      }
      ?>
      <style type="text/css">
...
<!-- End Alexa Certify Javascript -->  
    ...
    <body>
                ...
                <?php if($this->session->userdata('logged_in')!=TRUE): ?> 
                 ...
                 <ul class="nav navbar-nav navbar-right nav-custom">
                  ...
                  <li class="dropdown">
                   ...
                   <a href="#" class="dropdown-toggle left-space" data-toggle="dropdown">Sign up <b class="caret"></b></a>
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-12 form-custom">
                       ...
                       <div class="form-group">
                        ...
                        <input type="submit" class="btn  btn-success btn-block" name="signup" value="Login">
     ...
     <?php else: ?>
      ...
      <?php 
        $random_maptag = get_random_maptag();
        if($random_maptag->num_rows()>0){
        foreach ($random_maptag->result() as $maptag_name) {
          $name = $maptag_name->name;
        }
      ?>
       <ul class="nav navbar-nav navbar-right nav-custom">
                  ...
                  <li class="dropdown">
                   ...
                   <a href="#" class="dropdown-toggle left-space" data-toggle="dropdown" style="text-transform: uppercase;">Invite Friends<b class="caret"></b></a>

                   <ul class="dropdown-menu" style="padding: 15px;min-width: 208px;">
                     
                    <li style="padding-bottom: 40px;">
                        <a href="https://twitter.com/intent/tweet?text=http://mapta.gs/<?php echo $name?>" onclick="return popitup(https://twitter.com/intent/tweet?text=http://mapta.gs/<?php echo $name?>" target="_blank" class="btn btn-block btn-social btn-twitter" style="margin-left: 0;padding-top: 5px;padding-left: 43px;padding-bottom: 5px;width: 75%;float:right">
                          <i class="fa fa-twitter"></i> Twitter
                        </a>
                    </li>
                    <li style="padding-bottom: 40px;">
                      <a href="https://www.facebook.com/sharer/sharer.php?u=http://mapta.gs/<?php echo $name?>" target="_blank" class="btn btn-block btn-social btn-facebook" style="margin-left: 0;padding-top: 5px;padding-left: 43px;padding-bottom: 5px;width: 75%;float:right">
                        <i class="fa fa-facebook"></i> Facebook
                      </a>
                    </li>
                    <li style="padding-bottom: 40px;">
                      <a href="https://plus.google.com/share?url=http://mapta.gs/<?php echo $name?>" target="_blank"  class="btn btn-block btn-social btn-google-plus" style="margin-left: 0;padding-top: 5px;padding-left: 43px;padding-bottom: 5px;width: 75%;float:right">
                        <i class="fa fa-google-plus"></i> G+
                      </a>
                    </li>
                      <li style="padding-bottom: 40px;">
                          <a href="<?php echo base_url()?>actions/track_code_action/referrer/<?php echo $name?>" target="_blank" class="btn btn-block btn-social btn-google-plus" style="margin-left: 0;padding-top: 5px;padding-left: 43px;padding-bottom: 5px;width: 75%;float:right">
          ...
          <form class="form-horizontal" name="fmadd">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="roosh form-control" name="roosh" placeholder="Maptag">
         ...
         <div class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" id="website" placeholder="Website address">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p style="font-size:15px">Congratulations your Maptag is Good-to-Go !!! </p>             
        <span style="font-size:15px"> Here's the share cum referral link : </span>  &nbsp;   &nbsp;             
        <span style="font-size:15px" id="modalname"></span>  
        
          <p style="font-size:15px">
          <br>  18,000 Maptags are taken already, cool Maptags are going away like hot cakes
              <br>  Pick cool Maptags(words) before others do which 
                  <b><a href="https://www.youtube.com/watch?v=MrtX-DsYHH4"  target="_blank" >you can sell later</a>  </b>
             <br>
            
        </p> 
        <p> People really Love The <b> <a href="https://www.facebook.com/hashtag/addressrevolution"  target="_blank" >#addressrevolution</a> </b> , Share yours too </p>
        <hr>
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="share_maptagLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Welcome to Maptags, the Address revolution. </h4>

      </div>

      <div class="modal-body">
         <p style="fon-size:15px">
          Maptags shortens your address to your favourite word and makes it super easy to remember and share
           <br>  15,000 Maptags taken already,Pick your favourite word before its gone <br>
          please sign up and be a part of this Revolution.  <br> <br> 
          Facebook or Google is Single Click sign-up (we don't store your passwords)    
          </p>
        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="row">
              <div class="col-md-12 ">
                <a id="gpluslogin" href="<?php echo base_url() ?>user/social_login/Google"><img src="<?php echo base_url() ?>assets/img/g+.png"></a>
                <a id="fblogin" href="<?php echo base_url() ?>user/social_login/Facebook"><img src="<?php echo base_url() ?>assets/img/facebook.png"></a>
              </div>
...
<div class="modal fade" id="share_maptag_social" tabindex="-1" role="dialog" aria-labelledby="share_maptag_socialLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Welcome to the address revolution. </h4>
...
<div class="modal fade" id="create-maptag" tabindex="-1" role="dialog" aria-labelledby="create-maptagLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Welcome to the Maptags, the Address Revolution. </h4>

      </div>

      <div class="modal-body">
        <p style="font-size:15px">We are thrilled to have you.</p>

        <p> Create a  Maptag and start your journey, it just takes 30 secs </p>
        <p style="font-size:15px">Simply Click on the Red pin , choose your Maptag and fill the address</p> <br>


        <p> If in doubt Refer the <b> <a href="<?php echo base_url() ?>site/howitswork">how it works tab</a> </b> For step by step Instructions.</p>
...
<div class="modal fade" id="show_maptag" tabindex="-1" role="dialog" aria-labelledby="show_maptagLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p style="font-size:15px">Thanks For creating Maptag</p>             
      </div>
