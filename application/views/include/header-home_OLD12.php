      ...
      <div class="modal-body">
        ...
        <span style="font-size:15px" id="modalname"></span>  
         <p style="font-size:15px">
            <br> <b>
          Be a HERO, help your friends to Never write an address or Never lose way ..Earn Credits while doing it 
              </b>
...
<div class="col-md-6 col-sm-6 col-lg-6" style="margin:0;padding:8px;"><div class="well" style="margin-bottom:0"> <b>'+name+'</b><br/>'+adderss+', '+address1+' <br>'+city+' '+zip+' '+state+'</div><br/><a href="tel:'+phone+'">'+phone+'</a><br><a href="http://www.'+website+'" target="_blank">'+website+'</a><br><div id="share-buttons">
<div class="item"> <a href="https://www.facebook.com/sharer/sharer.php?u=http://mapta.gs/'+msg.name+'" onclick="return popitup(https://www.facebook.com/sharer/sharer.php?u=http://mapta.gs/'+msg.name+')" target="_blank">
<img src="http://mapta.gs/assets/images/share/facebook.png" alt="Facebook"/></a><span class="cap"></span></div> <div class="item"><a href="http://twitter.com/share?url=http://mapta.gs/'+msg.name+'&text=Join the addressrevolution and never write an address&hashtags=addressrevolution" onclick="return popitup(http://twitter.com/share?url=http://mapta.gs/'+msg.name+'&text=Join the addressrevolution and never write an address&hashtags=addressrevolution)" target="_blank"><img src="http://mapta.gs/assets/images/share/twitter.png" alt="Twitter"/></a><span class="cap"></span></div>  <div class="item">
<a href="https://plus.google.com/share?url=http://mapta.gs/'+msg.name+'" onclick="return popitup(https://plus.google.com/share?url=http://mapta.gs/'+msg.name+')" target="_blank">
<img src="http://mapta.gs/assets/images/share/google.png" alt="Google"/>
</a>
<span class="cap">
</span>
</div> 
<div class="item"><a href="https://www.google.com/maps/dir//'+msg.lat+','+msg.lng+'/@'+msg.lat+','+msg.lng+',14z?hl=en" target="_blank"><img src="http://mapta.gs/assets/images/direction.png" style="width: 28px;"> </a><span class="cap">Direction</span></div></div></div><div class="col-md-6 col-sm-6 col-lg-6" style="margin-top:15px;"> '+image+'<br> <a class="btn  btn-success wss_save" href="javascript:closeTo(\''+msg.name+'\');">Save Maptag</a><br><span class="log"></span></div><div class="col-md-12" style="margin:0;padding:8px">'+description+'</div></div>',
