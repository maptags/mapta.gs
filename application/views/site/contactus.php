...
<div style="margin-top: 45px;text-align: center;" >   
    <div class="col-md-12">
	    <div class="pull-left"><h4>Address:</h4>  <h4>Maptags Techno Solutions Private Limited</h4></div>
  		<div class="clearfix"></div>
  		<div class="pull-left" style="margin-bottom:2em;margin-top:1em;"><b></b>
         <p class="pull-left"> <a href="http://mapta.gs/theoffice" target="_blank">mapta.gs/theoffice </a></p>
  		</div>
  		<div class="clearfix"></div>
		</div>
    </div>   
