        ...
        <fieldset>
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
            <a id="gpluslogin" href="<?php echo base_url() ?>user/social_login/Google" onclick="ga('send', 'event', 'GFlogin2', 'Click', 'Glog2');"><img src="<?php echo base_url() ?>assets/img/g+.png"></a>
    <a id="gpluslogin" href="<?php echo base_url() ?>user/social_login/Facebook" onclick="ga('send', 'event', 'GFlogin2', 'Click', 'Flog2');"><img src="<?php echo base_url() ?>assets/img/facebook.png"></a>
      ...
      <?php } ?>
        ...
        <!-- Prepended text-->
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="pull-left">
                <a href="<?php echo base_url()?>user/register" onclick="ga('send', 'event', 'GFlogin2', 'Click', 'Rlog');" class="btn  btn-info"><i class="fa fa-location-arrow"></i> Register</a>
              </div>
